      ...
      <div class="col-lg-6" style="margin-bottom: 20px">
        <div class="box-main" style="border-color: #1E88E5; height: 100%">
          ...
          <div class="row" style="padding: 10px 20px">
            <img class="col-md-6 logo" src="../assets/logos/supergen.png">
            <img class="col-md-6 logo" src="../assets/logos/turing.png">
          </div>
          <div class="row" style="padding: 10px 20px">
            <img class="col-md-6 logo" src="../assets/logos/newcastle.png">
            <img class="col-md-6 logo" src="../assets/logos/lrf.svg">
          </div>
        </div>
      </div>
    </div>
